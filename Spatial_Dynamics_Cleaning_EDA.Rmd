...
saveRDS(cor_lengths_W, "W_correlation_lengths.rds")
saveRDS(list_Cr_W, "W_Cr.rds")
...
```{r}
# Assuming 'poverty' is your original dataframe

# Create a copy of the poverty dataframe
pov <- poverty

# Convert necessary columns to numeric if not already (assuming pov already has these columns as numeric based on your setup)
...
# Assuming pov is your dataframe with the Tier_Poverty column and potentially NA values
