...
# Weekly Spatial Metrics for MHHINC
for (r in 1:40) {
  localcor = urban_localcor_region_mhhinc[[r]]
...
View(region_mhhinc_weekly_localcor)
```
...
# save to cs
write.csv(region_mhhinc_weekly_localcor, "urban_region_mhhinc_weekly_localcor.csv")
```
...
df_long <- gather(weekly_spatial_metrics, key = "r", value = "value", -week_start_date, -total_cases, -marginal_cases, -cor_lengths, -next_week_marginal_cases)
