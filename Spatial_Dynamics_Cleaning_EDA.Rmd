...
# saveRDS(urban_mhhinc_cor_lengths, "urban_mhhinc_correlation_lengths.rds")
# saveRDS(urban_mhhinc_list_Cr, "urban_mhhinc_Cr.rds")
...
# Weekly Spatial Metrics for Regions
for (r in 1:10) {
  list_Cr = urban_Cr_mhhinc[[r]]
  cor_lengths = urban_cor_lengths_mhhinc[[r]]
...
unique(mhhinc_weekly_spatial_metrics$mhhinc_tier)
```
...
urban_mhhinc_weekly_spatial_metrics = mhhinc_weekly_spatial_metrics
# save to cs
# write.csv(urban_mhhinc_weekly_spatial_metrics, "urban_mhhinc_weekly_spatial_metrics.csv")
```
