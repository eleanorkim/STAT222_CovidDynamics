...
saveRDS(all_cor_lengths, "mhhinc_tiers_correlation_lengths.rds")
saveRDS(all_list_Cr, "mhhinc_tiers_Cr.rds")
...
# add wave dummies
regional_weekly_spatial_metrics$northeast <- ifelse(regional_weekly_spatial_metrics$region == "Northeast", 1, 0)
regional_weekly_spatial_metrics$midwest <- ifelse(regional_weekly_spatial_metrics$region == "Midwest", 1, 0)
regional_weekly_spatial_metrics$south <- ifelse(regional_weekly_spatial_metrics$region == "South", 1, 0)
...
head(poverty_weekly_spatial_metrics)
```
...
for (r in 1:16) {
  list_Cr = Cr_mhhinc[[r]]
  cor_lengths = cor_lengths_mhhinc[[r]]
