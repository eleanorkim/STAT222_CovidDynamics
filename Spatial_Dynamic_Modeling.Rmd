...
```{r}
# Weekly Spatial Metrics with Poverty & Median Household Income Columns 
...
print(robust_test)
# Print Result
paste("a 10% increase in correlation length corresponds to a ", round(northeast_model$coefficients[2]*10,2),"% change in cases in the following week")
```
```{r}
# simple model for poverty tier (1,1)
...
print(robust_test)
# Print Result
paste("a 10% increase in correlation length corresponds to a ", round(midwest_model$coefficients[2]*10,2),"% change in cases in the following week")
```
...
print(robust_test)
# Print Result
paste("a 10% increase in correlation length corresponds to a ", round(south_model$coefficients[2]*10,2),"% change in cases in the following week")
```
...
print(robust_test)
# Print Result
paste("a 10% increase in correlation length corresponds to a ", round(west_model$coefficients[2]*10,2),"% change in cases in the following week")
```
