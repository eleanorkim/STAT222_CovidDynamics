...
Output: poverty_weekly_spatial_metrics
  ...
  - features: start date of week, total cases, marginal cases, next week's marginal cases, C(r) for distance intervals from [0,50] to [970,1000], correlation length, poverty tier of pair, poverty tier of county 1, poverty tier of county 2, pov tier 1 dummy, pov tier 2 dummy, pov tier 3 dummy
